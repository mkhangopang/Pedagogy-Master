...
export default function DocumentUploader({ userId, userPlan, docCount, onComplete, onCancel }: DocumentUploaderProps) {
  ...
  if (mode === 'transition') {
    return (
      <div className="bg-white dark:bg-slate-900 rounded-3xl md:rounded-[3rem] p-1 w-full max-w-5xl shadow-2xl border dark:border-white/5 animate-in zoom-in-95 flex flex-col h-[92vh] md:h-[85vh] overflow-hidden">
        ...
        <div className="p-6 md:p-8 bg-slate-50 dark:bg-slate-900/50 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
